/*
 * whereTheFuckAreYouGoing.js v1.0.0
 * 
 * Copyright 2017 Angelo Calabrò
 * MIT License
 *
 */

function wtfayg(callback, options){
	var defaultOptions = {
		minimumView: 50,
		scrollUp: 10,
	...
	this.init = function(){
		...
		jQuery(window).scroll(this.debounce(function(){
			if(!that.disabled){
				that.disabled = true;
				clearTimeout(t);
